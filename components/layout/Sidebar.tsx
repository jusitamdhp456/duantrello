...
import { LayoutDashboard, CheckSquare, Target, DollarSign, Settings, Video, Award, Image as ImageIcon } from "lucide-react";
...
export default function Sidebar() {
  ...
  const navItems = [
    ...
    { href: "/photo-tasks", label: "nav_photo_todo", icon: ImageIcon },

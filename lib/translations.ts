export const translations = {
  en: {
    ...
    nav_todo: "Video To-Do Tasks",
    nav_photo_todo: "Photo To-Do Tasks",
  ...
  vi: {
    ...
    nav_todo: "Video Cần làm",
    nav_photo_todo: "Ảnh cần làm",
    nav_meetings: "Meetings",
    ...
    task_status_pending: "Chờ làm",
    task_status_in_progress: "Đang làm",
    task_status_review: "Chờ duyệt",
    task_status_revision: "Cần sửa",
    task_status_completed: "Hoàn thành",
    task_status_cancelled: "Hủy",
    task_priority_low: "Thấp",
    task_priority_medium: "Trung bình",
    task_priority_high: "Cao",
    task_priority_urgent: "Khẩn cấp",
    task_deadline: "Deadline",
    ...
    task_edit: "Sửa công việc",
    task_delete: "Xóa",
    task_save: "Lưu",
    task_cancel: "Hủy",
    task_total: "Tổng công việc",
    task_overdue: "Quá hạn",
    task_empty: "Chưa có công việc nào.",
    task_add: "+ Tạo công việc",
